...
class Operators:
    '''
    Operators used in QMES circuit
    '''
    ...
    def __init__(self, msystem):
        ...
        Parameters: 
            msystem (MatrixSystem): the matrix system that contains the matrix and RHS of the matrix equation
        '''
    ...
    def Bj(self, j):
        '''
        Bj is the state preparation operator that prepares |phi_j> from the |0> state (Fig. 6 on p. 12)
        '''
